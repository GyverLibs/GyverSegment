...
#### Яркость
У дисплеев с динамической индикацией доступна функция `maxDuty()`, которая устанавливает максимальное значение яркости. Это значение можно поднять до `255` и получить более плавное управление яркостью, а также более тусклую минимальную яркость при значении `1`!
